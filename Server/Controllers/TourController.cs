...
namespace Server.Controllers
{
  ...
  public class ToursController : ControllerBase
  {
    ...
    {
      return new JsonResult(data.getTours(tour_description, year));
    }

    [HttpDelete]
    [Route("DeleteTour/{tour_description}&{year}&{tourId}")]
    public IActionResult DeleteTour(string tour_description, int year, string tourId)
    {
      data.DeleteTour(tour_description, year, Guid.Parse(tourId));
      return Ok();
    }
